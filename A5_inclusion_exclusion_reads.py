...
def A5_inclusion(j_ref_l, j_ref_r, j_alt_l, j_alt_r, read_start, cigar):# 5bp overhangs#
...
def inc_exc(j_ref_l, j_ref_r, j_alt_l, j_alt_r,sam):
    ...
    with open(sam) as f:
        for l in f:
            ...
            in_count, ex_count = A5_inclusion(j_ref_l, j_ref_r, j_alt_l, j_alt_r,read_start,cigar)
